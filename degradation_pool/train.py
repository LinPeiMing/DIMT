...
def main():
    ...
    prog.add_argument('--input-dir', '-i', type=str, default='/media/li547/LinPeiMing/Dataset/NTIRE2018track3(difficult)/DIV2K_train_LR_difficult', help='path to image input directory.')
    prog.add_argument('--output-dir', '-o', type=str, default='/media/li547/LinPeiMing/1/SC-NAFSSR-main/KernelGAN/kernel pool', help='path to image output directory.')
